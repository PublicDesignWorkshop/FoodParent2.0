...
require('./donate-graph.component.scss');
...
export default class DonateGraph extends React.Component {
  ...
  render () {
    ...
    return (
      <div ref="wrapper" className="donate-graph-wrapper">
        <div className="donate-graph-label">{localization(38)}</div>
