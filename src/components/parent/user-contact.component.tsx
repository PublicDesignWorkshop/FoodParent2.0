...
export default class UserContactComponent extends React.Component<IUserContactProps, IUserContactStatus> {
  ...
  render() {
    let self: UserContactComponent = this;
    if (self.props.editable || self.props.person.getId() == 0) {
      return (
        <div className={styles.wrapper}>
          ...
          <div className={styles.edit}>
            <input type="email" className={styles.input} key={self.props.person.getId() + "email"} placeholder="enter e-mail address..."
